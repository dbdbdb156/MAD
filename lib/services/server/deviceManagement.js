...
////////////////////////// read2 : device 에 Client 에게 데이터 요청을 한번 더 한다. ////
//////////////////////////////////////////////////////////////////////////////////////
/*
function read2(deviceId, callback) {
    ...
    async.waterfall([
        apply(registry.get, deviceId),
        createReadRequest,
        coapUtils.sendRequest2,
        coapUtils.generateProcessResponse2('2.05')
    ], callback);
}
*/
//////////////////////////////////////////////////////////////////////////////////////
...
function writeResource(method, deviceId, objectType, objectId, resourceId, value, callback) {
    ...
    async.waterfall([
	// registry.get 함수를 실행하는데 이 deviceID 를 사용하겠습니다.
        apply(registry.get, deviceId),
        createUpdateRequest,
        coapUtils.sendRequest,
        processResponse
